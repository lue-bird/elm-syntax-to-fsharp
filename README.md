...
-   only a subset of elm is currently supported. not supported:
    ...
    -   potential future candidates: `Basics.logBase`, `Basics.never`, `List.map5`, `List.map4`, `Char.isAlpha`, `Char.isAlphaNum`, `Char.isOctDigit`, `Char.toLocaleLower`, `Char.toLocaleUpper`, `List.head`, `List.tail`, `List.unzip`, `Dict.update`, `Dict.merge`, `Dict.intersect`, `Bitwise.shiftRightZfBy`, `Set`, `Array`. Any help appreciated!
